{{-- nav pour lg --}}
<div class="absolute items-center justify-between hidden w-full lg:flex xl:gap-10 xl:px-48 lg:gap-5 2xl:text-md 2xl:gap-20 2xl:px-72 lg:px-32">
    ...
    <div class="hidden gap-8 pt-10 text-white lg:flex">
        <div class="flex items-center gap-8">
            ...
            <a href="#">Actualites</a>
            {{-- <a href="#">contact</a> --}}
            <button class="flex items-center gap-2 px-2 py-1 text-gray-700 bg-white rounded">
