<div x-data="{
    ...
    <div class="grid grid-cols-12 gap-2 mt-6">
        ...
        {{-- left images box --}}
        <div class="grid grid-cols-2 col-span-12 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:hidden">
            <img src="{{ asset('img/maison/2466_1.jpg') }}" alt="" class="rounded-2xl">
            <img src="{{ asset('img/maison/2466_1.jpg') }}" alt="" class="rounded-2xl ">
            <img src="{{ asset('img/maison/2466_1.jpg') }}" alt="" class="hidden rounded-2xl sm:grid">
        </div> 
        ...
        <div class="items-center justify-center hidden col-span-12 px-2 py-2 border-red-200 lg:col-span-4 lg:py-0 lg:flex lg:px-0 lg:flex-col rounded-2xl lg:border">
            ...
            <div class="flex flex-col p-2 text-white h-36 rounded-b-2xl">
                ...
                <button class="flex items-center justify-center gap-2 py-2 mt-2 text-red-600 bg-white border rounded-lg">
                    Contacter appel
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
