                ...
                <div class="splide__track">
                    ...
                    @foreach (Storage::files('public/biens/'.$bien->id.'/') as $img)                    
                        <li class="splide__slide">
                            <img src="{{ asset(str_replace('public', 'storage', $img)) }}" alt="" class="cursor-pointer h-20">        
                        </li>
                    @endforeach  
                    </ul>
                </div>
            ...
            <section id="main-carousel" class="splide" aria-label="My Awesome Gallery">
                <div class="splide__track">
                  <ul class="splide__list">
                    @foreach (Storage::files('public/biens/'.$bien->id.'/') as $img)                    
                        <li class="splide__slide">
                            <img src="{{ asset(str_replace('public', 'storage', $img)) }}" alt="" class="cursor-pointer rounded-2xl h-20">
                        </li>
                        @endforeach           
                  </ul>
                </div>
