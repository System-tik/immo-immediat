<div x-data="{
    ...
    <div class="py-5 ">
        <div class="flex flex-col gap-4 mx-10 divide-y-2">
            <div class="p-2">   
                <h1 class="text-xl font-bold text-right divide-x-4 divide-gray-300">Contacts d'immo-immediate</h1>
                <div class="flex flex-col py-5">
                    <div class="flex flex-1 gap-5 py-5">
                        <input type="text" class="flex-1 p-2 placeholder-gray-700 border-2 rounded-lg" placeholder="Libellé" id="lib" wire:model="lib">
                        <input name="h" id="url" wire:model="url" class="flex-1 p-2 placeholder-gray-600 transition transform border rounded-lg" placeholder="Contenu" />
                        <input name="" id="" wire:model="icon" class="flex-1 p-2 placeholder-gray-600 transition transform border rounded-lg" placeholder="Icon" />
                    </div>
    ...
    <div class="absolute top-0 left-0 w-full bg-black cacher" id="notif2">
    ...
    @endif --}} 
    <script>
        var b = document.querySelector('#notif2');
        window.addEventListener('Updated', event => {
            b.style.transform = "scale(0.2)";
            setTimeout(() => {
