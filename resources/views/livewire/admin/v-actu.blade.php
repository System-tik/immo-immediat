            ...
            <div class="p-2">   
                ...
                <div class="flex flex-col py-5">
                    <div class="flex flex-1 gap-5 py-5">
                        <input type="text" class="flex-1 p-2 placeholder-gray-700 border-2 rounded-lg" placeholder="Titre de l'actualité" wire:model="titre">
                        @error('titre') <span class="text-red-600">{{ $message }}</span><br> @enderror
                        <input type="text" class="flex-1 p-2 placeholder-gray-700 border-2 rounded-lg" placeholder="Description" wire:model="descrip">
                    ...
                    <div class="flex">
                        ...
                        <button class="flex-1 text-lg font-bold text-white bg-gray-500 -3" wire:click="resetFields" @click="url='';titre='';id=0;type='';descrip='';">Clear</button>        
                    </div>
